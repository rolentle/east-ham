...
def names():
    ...
    welsh_town_name_corpus = Corpus(file_name="./welsh_town_names.txt")
    ...
    welsh_names = [ welsh_name for welsh_name in EnglishTownNameGenerator(welsh_town_name_corpus).generate_times(20)]
